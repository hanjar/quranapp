  ...
  template: `
    <div class="modal-overlay" (click)="close.emit()">
      <div class="modal-content" (click)="$event.stopPropagation()">
        ...
        <div class="bookmark-meta-info" *ngIf="!isEdit()">
          <strong>Surah {{ surahNameEn() }}</strong> ({{ surahNameAr() }}) Ayat {{ ayah() }}<br>
          <span class="meta-sub">Juz {{ juz() }} &bull; Halaman {{ page() }}</span>
        </div>
  ...
  async onSave() {
    ...
    if (b) {
      ...
      if (b.id) {
        ...
        this.bookmarkService.add(b.surah, b.ayah, b.surahNameAr, b.surahNameEn, b.page || 0, b.juz || 0, targetId, this.label());
      ...
      this.bookmarkService.add(this.surah(), this.ayah(), this.surahNameAr(), this.surahNameEn(), this.page(), this.juz(), targetId, this.label());
    }
